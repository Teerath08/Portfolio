...
import { Cpu, User, GraduationCap, Briefcase, Mail, Home } from "lucide-react";
...
export default function QuickNav() {
  ...
  return (
    <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-40 max-w-[95vw]">
      <div className="flex items-center gap-1 p-1.5 rounded-full bg-background/90 border border-red-900/60 shadow-2xl shadow-red-950/40 backdrop-blur-xl transition-all duration-300 hover:border-red-600/70">
        {/* Quick Links */}
            ...
            return (
              <button
                ...
                className={`flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-medium transition-all duration-200 cursor-pointer ${
                  isActive
                    ? "accent-text bg-gradient-to-r from-red-600 to-rose-600 text-white shadow-lg shadow-red-600/40 font-semibold scale-105"
